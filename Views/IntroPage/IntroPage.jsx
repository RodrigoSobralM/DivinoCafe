    ...
    <>
      <div className="carrossel" id="next">
        {images.map((image, index) => (
          <div
            key={index}
            className={`carrossel__item ${index === current ? "active" : ""}`}
          >
      ...
      <div className="carrossel__geral">
        ...
        <div className="carrossel__texto-divino">
          <h1>
            Bem vindo ao <strong>Divino Café & Cia</strong>
          </h1>
          <p>
            Breve descrição sobre o café ou alguma frase que fale sobre o
            espírito da empresa
          </p>
        </div>
        <div className="carrossel__btn">
          <button>
            <Link to={`/Home`} className="carrossel__button-menu">
              ENTRAR
            </Link>
          </button>
        </div>
